...
export async function updateOptions(data: UpdateOptionsRequest): Promise<UpdateOptionsResponse> {
    const result = await client.post<UpdateOptionsResponse>(`/employee/options`, data, {
        timeout: 3000,
    });
