...
export async function FetchOptions(params: FetchOptionsRequest): Promise<FetchOptionsResponse> {
    const result = await client.get<FetchOptionsResponse>(`/employee/options`, {
        params,
        timeout: 3000,
    });
